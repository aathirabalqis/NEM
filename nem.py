...
def atbfile():
    ...
    global atbdf, atbpath, folder, out
...
textvar = StringVar()
Entry(root, textvariable = textvar, width = 28, font = ('calibre',10,'normal')).place(x = 40, y = 150, height = 20)

Button(root, text = 'NEM Report', command = getrep).place(x = 257, y = 147)
Button(root, text = 'NR Meters', command = getnr).place(x = 333, y = 147)
Button(root, text = 'UDC ID', command = getudc).place(x = 400, y = 147)
